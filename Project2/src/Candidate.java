...
public class Candidate {
  ...
  private Queue<Integer> voter_id_list;  // a list of voter id(s) that have voted for this candidate
  private LinkedList<Integer> dis_voter_id_list;
  ...
  public Candidate(int id, String name) {
    ...
    num_vote = 0;
    status = 0;
    voter_id_list = new LinkedList<>();
    dis_voter_id_list = new LinkedList<>();
    order = -1;
  }
  ...
  public Queue<Integer> get_voter_id_list() { return voter_id_list; }

  /** @return invalidated ballot list of the election */
  public LinkedList<Integer> get_dis_voter_id_list() { return dis_voter_id_list; }
